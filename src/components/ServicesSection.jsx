...
const ServicesSection = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-[#030026] via-[#0b0033] to-[#1a004d] text-white py-20 px-6 md:px-16 overflow-hidden">
      {/* Section Header */}
      <div className="text-center mb-16">
        <button className="bg-[#12013d] px-8 py-2 rounded-full text-gray-300 text-xl mb-6 border border-[#3c006a]/30">
          Our Services
        </button>
      ...
      {/* Cards - move on hover but background stays still */}
      <div className="flex flex-col items-center space-y-12 max-w-5xl mx-auto relative z-10">
        {services.map((service, index) => (
          <div
            key={index}
            className="relative w-full bg-gradient-to-br from-[#0d0026] via-[#15003b] to-[#1f004d] 
            p-10 rounded-3xl shadow-2xl border border-[#2a005f]/40 
          ...
          >
            ...
            <div className="space-y-4">
              {service.features.map((item, i) => (
                <div
                  key={i}
                  className="border-b border-gray-700 flex justify-between items-center pb-3 cursor-pointer"
                >
            ...
            {/* Floating Icon */}
            <div className="absolute bottom-8 right-8 bg-gradient-to-r from-purple-600 to-pink-500 hover:opacity-90 transition p-4 rounded-full">
